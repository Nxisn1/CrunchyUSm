...
$Query_anime = $conexion->prepare("SELECT Nombre, puntuacion FROM animes ORDER BY puntuacion DESC LIMIT 5;"); //top 5
$Query_anime-> execute();
...
<div class="card text-left">
  ...
  <div class="card-body">
    <h4 class="card-title">Top 5 animes con mayor valoración:</h4><p></p>
