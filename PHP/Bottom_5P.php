...
$Query_peli = $conexion->prepare("SELECT Nombre, puntuacion FROM peliculas ORDER BY puntuacion ASC LIMIT 5;"); //top 5
$Query_peli-> execute();
...
<div class="card text-left">
  ...
  <div class="card-body">
    <h4 class="card-title">Top 5 películas con menor valoración:</h4><p></p>
