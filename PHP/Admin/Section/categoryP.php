...
$Id_pelicula = $_GET["id"]; //recuperamos el Id_pelicula desde la linea 295 de Admin/Section/Animes.php
            ...
            <tr>
                ...
                <td> 
                    <?php 
                            ...
                            if($genero[13] == 1){echo "Sobrenatural <br>";}if($genero[14] == 1){ echo "Thriller <br>";}if($genero[0]==0 && $genero[1]==0 && $genero[2]==0 && $genero[3]==0 && $genero[4]==0 && $genero[5]==0 && $genero[6]==0 && $genero[7]==0 && $genero[8]==0 && $genero[9]==0 && $genero[10]==0 && $genero[11]==0 && $genero[12]==0 && $genero[13]==0 && $genero[14]==0){ echo "Ingresa las etiquetas de esta película.";}
                    ?> 
                </td>
            </tr>
        </tbody>
